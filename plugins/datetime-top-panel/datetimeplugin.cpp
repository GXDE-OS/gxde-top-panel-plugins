...
void DatetimePlugin::updateCurrentTimeString()
{
    ...
    if (m_centralWidget->is24HourFormat())
        m_dateTipsLabel->setText(QLocale::system().toString(currentDateTime.date(), QLocale::LongFormat) + currentDateTime.toString(" HH:mm:ss"));
    else
        m_dateTipsLabel->setText(QLocale::system().toString(currentDateTime.date(), QLocale::LongFormat) + currentDateTime.toString(" hh:mm:ss A"));
